...
export default function ComprendreTMSPage() {
 return (
    ...
    <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-12 sm:px-6 md:pb-16 md:pt-16">
      <FadeIn>
        ...
        <h1 className="bs-display-section text-ink mt-4">Comprendre les TMS</h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-ink-soft md:text-lg">Définition, causes et prévention des troubles qui touchent les muscles, les tendons et les articulations.</p>
      </FadeIn>
    </div>
  </section>
 ...
 <div className="text-center p-6 bg-card/50 rounded-2xl border border-line hover:border-brand/20 transition-colors h-full">
