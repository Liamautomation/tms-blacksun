...
const blocs = [
 ...
 { key: "equipements" as const, icon: Wrench, label: "Équipements", color: "text-ink", bg: "bg-card-tint", border: "border-line" },
 ...
 return (
    ...
    <div className="relative mx-auto max-w-7xl px-4 pb-12 pt-12 sm:px-6 md:pb-16 md:pt-16">
      <FadeIn>
        ...
        <h1 className="bs-display-section text-ink mt-4">Fiches de poste</h1>
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-ink-soft md:text-lg">Risques, gestes recommandés, équipements et signaux d&apos;alerte — pour chaque métier du salon.</p>
      </FadeIn>
    </div>
  </section>
