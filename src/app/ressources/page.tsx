  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20">
      ...
      <FadeIn className="max-w-3xl mb-14">
        ...
        <h1 className="bs-display-section text-ink">Ressources</h1>
        <p className="mt-4 text-lg text-ink-soft">Affiches, documents et liens utiles pour la prévention — téléchargez, imprimez, affichez.</p>
      </FadeIn>

      {/* ═══ AFFICHES — GRILLE BENTO ═══ */}
      <section className="mb-16 bs-arc-section pt-10">
