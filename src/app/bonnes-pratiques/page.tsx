  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 md:py-20">
      ...
      <FadeIn className="max-w-3xl mb-14">
        ...
        <h1 className="bs-display-section text-ink">Bonnes pratiques</h1>
        <p className="mt-4 text-lg text-ink-soft">Six protocoles de prévention à appliquer au quotidien — des gestes simples qui changent tout.</p>
      </FadeIn>
      ...
      <FadeIn className="mb-14">
        <div className="bs-card overflow-hidden bs-arc">
          <div className="aspect-video bg-gradient-to-br from-card to-card-tint flex items-center justify-center relative">
            <div className="absolute inset-0 bs-solar-glow opacity-30" aria-hidden="true" />
